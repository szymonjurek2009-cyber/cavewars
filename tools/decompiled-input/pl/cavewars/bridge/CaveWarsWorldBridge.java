...
public final class CaveWarsWorldBridge extends JavaPlugin implements Listener {
   ...
   public void onEnable() {
      try {
         ...
         this.getLogger().info("CaveWarsWorldBridge enabled.");
      } catch (Throwable var3) {
         this.getLogger().severe("Cannot connect to CaveWarsWorlds API: " + var3.getMessage());
      }
   }
   ...
   public void onPlayerCommand(PlayerCommandPreprocessEvent var1) {
      ...
      if (var2.equals("/cw join") || var2.equals("/cavewars join")) {
         try {
            ...
            CompletableFuture var5 = (CompletableFuture)this.createArena.invoke(this.api, new Object[]{"cavewars", "cavewars"});
            var5.whenComplete((var2x, var3x) -> Bukkit.getScheduler().runTask(this, () -> {
               ...
               if (var3x == null && var2x instanceof World var4x) {
                  try {
                     ...
                     this.getLogger().severe("Arena sync failed: " + var6x.getMessage());
                  ...
                  this.getLogger().severe("Arena creation failed: " + var5x);
                  var4.sendMessage("§8[§6CaveWars§8] §cNie udało się utworzyć areny.");
               }
            }));
         } catch (Throwable var6) {
            var1.setCancelled(true);
            this.getLogger().severe("Join bridge failed: " + var6.getMessage());
   ...
   private void syncCaveWars(World var1) throws Exception {
      ...
      if (var5) {
         ...
         this.getLogger().info("CaveWars arena synced to world: " + var13);
      }
   }
