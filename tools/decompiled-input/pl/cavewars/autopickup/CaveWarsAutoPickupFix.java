...
import pl.cavewars.autopickup.CaveWarsAutoPickupFix.BreakContext;

public final class CaveWarsAutoPickupFix extends JavaPlugin implements Listener {
      ...
      if (var2 != null) {
         ...
         if (sameBreakLocation(var2.location, var4)) {
            ...
            if (var5 != null && var5.getAmount() > 0) {
               ...
               HashMap var8 = var2.player.getInventory().addItem(new ItemStack[]{var7});
               int var9 = 0;
