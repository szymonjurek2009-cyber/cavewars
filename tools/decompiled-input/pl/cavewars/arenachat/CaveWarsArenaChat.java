...
public final class CaveWarsArenaChat extends JavaPlugin implements Listener {
   public void onEnable() {
      this.getServer().getPluginManager().registerEvents(this, this);
      PluginCommand var1 = this.getCommand("arenachatdebugsend");
      if (var1 != null) {
   ...
   private boolean onTestCommand(CommandSender var1, Command var2, String var3, String[] var4) {
      ...
      Player var5 = this.getServer().getPlayerExact(var4[0]);
      if (var5 == null) {
         return false;
      }
